  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <motion.div
        ...
        className="bg-card rounded-xl shadow-lg p-8 max-w-lg w-full text-center border border-border"
      >
        <motion.h1
          initial={{ y: -20 }}
          animate={{ y: 0 }}
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="px-6 py-3 bg-brand text-brand-foreground font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-brand"
          onClick={() => {
          }}
        >
          Create Channel

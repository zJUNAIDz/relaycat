...
const CreateAnonymousChannelModal = () => {
  //* component beginning
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const url = qs.stringifyUrl({
        url: `${API_URL}/channels/anonymous`,

      })
      await axios.post(url, { channelName: values.name, creator: user }, {
        headers: {
...
export default CreateAnonymousChannelModal;
